...
from .spconv_backbone_aifad import PillarBackBone8xAIFAD, PillarBackBone8xAIFAD2D
from .virConv import VirConvL8x
...
__all__ = {
    ...
    'DSVT': DSVT,
    'VoxelResBackBone8xMyNet': VoxelResBackBone8xMyNet,
    'VirConvL8x': VirConvL8x,
    'PillarBackBone8xAIFAD': PillarBackBone8xAIFAD,
    'PillarBackBone8xAIFAD2D': PillarBackBone8xAIFAD2D,
}
