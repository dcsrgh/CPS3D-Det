...
class PillarBackBone8x(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        x_conv1 = self.conv1(input_sp_tensor)  # [1450, 758]  pillarnet [1600, 1408]
        x_conv2 = self.conv2(x_conv1)  # [725, 379]  pillarnet [800, 704]
        x_conv3 = self.conv3(x_conv2)  # [363, 190]  pillarnet [400, 352]
        x_conv4 = self.conv4(x_conv3)  # [182, 95]  pillarnet [200, 176]
