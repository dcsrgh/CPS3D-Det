...
from ..model_utils import save_to_txt
...
class MyNetHead(nn.Module):
    ...
    def assign_target_of_single_head(
        ...
        # radius = centernet_utils.gaussian_radius_v1(dx, dy, min_overlap=gaussian_overlap)
        ...
        for k in range(min(num_max_objs, gt_boxes.shape[0])):
            ...
            if 'gt_center' in self.gaussian_type:  # ['nearst', 'gt_center']
    ...
    def generate_predicted_boxes(self, batch_size, pred_dicts, voxel_indices, spatial_shape):
        ...
        for idx, pred_dict in enumerate(pred_dicts):
            if self.double_flip:
                ...
                # batch_rot_sin = pred_dict['rot'][:, 0].unsqueeze(dim=1)
        ...
        for k in range(batch_size):
            ...
            ret_dict[k]['pred_boxes'] = pred_boxes  # 159
    ...
    def forward(self, data_dict):
        ...
        if not self.training or self.predict_boxes_when_training:
            ...
            # 保存模型推理的特征
            # frame_id_list = data_dict['frame_id']
            # xyz_heat_dict = pred_dicts
            # save_to_txt.save_1('/gly/yury/Point_Cloud_Defect/openPCDet/output/0809_450_xyzHeat', frame_id_list, xyz_heat_dict)
            ...
            if self.predict_boxes_when_training:
                ...
                data_dict['final_box_dicts'] = pred_dicts  # 159
